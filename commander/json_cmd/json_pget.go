...
var jsonPGetCmd = &common.Command{
	Name:        "JSON.PGET",
	Description: ``,

	Syntax: "JSON.PGET <key> [<path>] [<populate>]",
	Example: `
	...
	Ok ["reading","hiking"]
	`,
	Execute: jsonPGetFunc,
}

func init() {
	common.Register(jsonPGetCmd.Name, jsonPGetCmd)
}

func jsonPGetFunc(cmd *common.Cmd) (*common.CmdResponse, error) {
...
func readPNestedKey(obj map[string]interface{}, path string) (interface{}, error) {
